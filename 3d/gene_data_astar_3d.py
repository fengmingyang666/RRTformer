...
def process_env(env):
    ...
    astar_gen = AStar3D(start=start, goal=goal, map_dim=map_dim, obstacle_list=obstacle_list)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate 3D A* Data')
    parser.add_argument('--envs_file', type=str, required=True, help='Path to the environment file')
    parser.add_argument('--output_path_file', type=str, default='../data/astar_3d.npy', help='Path to the output file')
